...
// through this trait; on stable the inherent `Vec::new` is used instead.
#[cfg(nightly)]
use crate::alloc::TursoAllocExt;
...
impl Connection {
                ...
                ReparsePhase::PopulateSequences {
                    ...
                    if pending.is_none() {
                        if let Some(sequences) = inner.preserved_sequences.take() {
                            ...
                            *pending = Some(crate::alloc::Vec::new());
                        } else {
    ...
    pub fn reparse_schema_after_extension_load(self: &Arc<Connection>) -> Result<()> {
        ...
        self.with_schema_mut(|schema| -> Result<()> {
            ...
            let mut from_sql_indexes = crate::alloc::Vec::new();
