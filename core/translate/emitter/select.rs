...
pub(crate) fn emit_materialized_build_inputs(
    ...
    for spec in materializations.iter() {
        ...
        let columns = match &spec.mode {
            MaterializedBuildInputMode::RowidOnly => crate::alloc::try_vec![build_rowid_column()]?,
...
fn build_materialized_input_columns(
    ...
    let mut columns: crate::alloc::Vec<Column> =
        crate::alloc::TursoVecExt::with_capacity(num_keys + payload_columns.len());
    for i in 0..num_keys {
