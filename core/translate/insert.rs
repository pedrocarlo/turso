...
fn translate_virtual_table_insert(
    ...
    // Prologue done in translate_insert
    ...
    program.epilogue(
        init_label,
        start_offset,
        // TODO: no transaction was being emitted before here, but maybe a write transaction is correct instead
        super::emitter::TransactionMode::None,
    );
